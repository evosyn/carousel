...
1. I’d like to be able to write one if statement for the entire login if that’s possible
2. An in-depth functionality list of scrollviews would be nice to have as a cheat sheet

### Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/AZDRHlN.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />
